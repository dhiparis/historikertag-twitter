# Tweet distribution during the conference 2012
...
plot_info <- c("2012-09-24","Historikertag 2012 (25.-28.09.2012)", "Tweets je 20 Minuten von 24.09.-29.09. Betrachtete Hashtags: #histag12, #historikertag12, #historikertag2012, #histtag12", "11_figure-tweet-distribution-2012.png")

# Filter by Date
tsMinute_histag_temp <- histag_all[histag_all$histag_12 == TRUE,] %>% dplyr::filter((created_at >= as.Date(plot_info[1], tz = "Europe/Berlin")) & (created_at <= as.Date(plot_info[1], tz = "Europe/Berlin") + 6))
