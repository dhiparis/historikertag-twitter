# Tweet distribution during the conference 2014
...
plot_info <- c("2014-09-22","Historikertag 2014 (23.-26.09.2014)", "Tweets je 20 Minuten von 22.09.-27.09. Betrachtete Hashtags: #histag14, #historikertag14, #historikertag2014, #histtag14", "12_figure-tweet-distribution-2014.png")

# Filter by Date
tsMinute_histag_temp <- histag_all[histag_all$histag_14 == TRUE,] %>% dplyr::filter((created_at >= as.Date(plot_info[1], tz = "Europe/Berlin")) & (created_at <= as.Date(plot_info[1], tz = "Europe/Berlin") + 6))
