# Tweet distribution during the conference 2018
...
plot_info <- c("2018-09-24","Historikertag 2018 (25.-28.09.2018)", "Tweets je 20 Minuten von 24.09.-29.09. Betrachtete Hashtags: #histag18, #historikertag18, #historikertag2018, #histtag18", "14_figure-tweet-distribution-2018.png")

# Filter by Date
tsMinute_histag_temp <- histag_all[histag_all$histag_18 == TRUE,] %>% dplyr::filter((created_at >= as.Date(plot_info[1], tz = "Europe/Berlin")) & (created_at <= as.Date(plot_info[1], tz = "Europe/Berlin") + 6))
